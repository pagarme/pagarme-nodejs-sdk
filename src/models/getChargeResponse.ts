...
} from './getPaymentOriginResponse.js';
...
export const getChargeResponseSchema: Schema<GetChargeResponse> = lazy(() =>
  object({
    ...
    lastTransaction: [
      'last_transaction',
      optional(nullable(discriminatedGetTransactionResponseSchema)),
    ],
    invoice: ['invoice', optional(nullable(getInvoiceResponseSchema))],
    order: ['order', optional(nullable(getOrderResponseSchema))],
    ...
    paymentOrigin: [
      'payment_origin',
      optional(nullable(getPaymentOriginResponseSchema)),
    ],
  })
);
