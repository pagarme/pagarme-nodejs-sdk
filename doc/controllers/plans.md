...
requestOptions?: RequestOptions): Promise<ApiResponse<GetPlanResponse>>
```
...
```ts
async updatePlanMetadata(  planId: string,
...
async updatePlanItem(  planId: string,
  ...
  idempotencyKey?: string,
requestOptions?: RequestOptions): Promise<ApiResponse<GetPlanItemResponse>>
```
...
async getPlans(  page?: number,
  ...
  createdSince?: string,
  createdUntil?: string,
requestOptions?: RequestOptions): Promise<ApiResponse<ListPlansResponse>>
```
